...
<body class="h-full flex flex-col font-sans antialiased">
        ...
        <section class="w-96 bg-white border-r border-slate-200 p-6 flex flex-col justify-between overflow-y-auto shadow-sm z-10">
            <div class="space-y-4">
                ...
                <div class="bg-amber-50 border border-amber-200 p-3 rounded-lg space-y-1.5">
                    <label class="block text-xs font-bold text-amber-900 uppercase tracking-wide"><svg class="w-4 h-4 inline-block mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg> Simulation Injector (Dynamic Barriers)</label>
                ...
                <div class="space-y-2">
                    <button onclick="activateLiveTracking()" class="w-full bg-emerald-600 hover:bg-emerald-50 text-white text-xs font-semibold py-2 px-4 rounded-md">
                        <svg class="w-4 h-4 inline-block mr-1 -mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg> Lock On Live Device GPS Coordinates
                    </button>
                ...
                <div id="travelTimeCard" class="bg-white border border-slate-200 text-slate-800 p-4 rounded-xl shadow-sm space-y-3 hidden mt-4">
                    <div class="flex justify-between items-center border-b border-slate-100 pb-2">
                        <h4 class="text-xs font-bold uppercase tracking-wider text-slate-500">Estimated Travel Times</h4>
                        <span id="routeDistance" class="bg-blue-100 text-blue-700 border border-blue-200 font-mono font-bold text-xs px-2.5 py-0.5 rounded-full">0.0 km</span>
                    </div>
                    <div class="grid grid-cols-2 gap-2 text-sm">
                        <div class="bg-slate-50 border border-slate-100 p-2 rounded flex justify-between items-center">
                            <span class="text-slate-500"><svg class="w-4 h-4 inline-block mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><circle cx="12" cy="5" r="2"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9L10 20M12 9l2 11M12 9V7M12 7H9M12 7h3"/></svg> Walking</span>
                            <span id="timeWalking" class="font-mono font-bold text-slate-700">-- mins</span>
                        </div>
                        <div class="bg-slate-50 border border-slate-100 p-2 rounded flex justify-between items-center">
                            <span class="text-slate-500"><svg class="w-4 h-4 inline-block mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><circle cx="5.5" cy="17.5" r="3.5" stroke-width="2"/><circle cx="18.5" cy="17.5" r="3.5" stroke-width="2"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 6a1 1 0 100-2 1 1 0 000 2zM5.5 17.5L9 11l4 2.5m0 0l2.5-4 1.5 1.5m-4 1L12 17.5"/></svg> Bike</span>
                            <span id="timeBike" class="font-mono font-bold text-slate-700">-- mins</span>
                        </div>
                        <div class="bg-slate-50 border border-slate-100 p-2 rounded flex justify-between items-center">
                            <span class="text-slate-500"><svg class="w-4 h-4 inline-block mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 13h18M5 13l2-6h10l2 6M5 17a2 2 0 100-4 2 2 0 000 4zM19 17a2 2 0 100-4 2 2 0 000 4z"/></svg> Car</span>
                            <span id="timeCar" class="font-mono font-bold text-slate-700">-- mins</span>
                        </div>
                        <div class="bg-slate-50 border border-slate-100 p-2 rounded flex justify-between items-center">
                            <span class="text-slate-500"><svg class="w-4 h-4 inline-block mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 7v10a2 2 0 002 2h12a2 2 0 002-2V7a2 2 0 00-2-2H6a2 2 0 00-2 2zM4 11h16M7 15h0M17 15h0"/></svg> Bus</span>
                            <span id="timeBus" class="font-mono font-bold text-slate-700">-- mins</span>
                        </div>
                    </div>
                </div>

                <!-- Weather/Atmospheric Radar Card -->
                <div id="weatherCard" class="bg-white border border-slate-200 text-slate-800 p-4 rounded-xl shadow-sm space-y-2 hidden mt-4">
                    <div class="flex items-center justify-between border-b border-slate-100 pb-2">
                        <h4 class="text-xs font-bold uppercase tracking-wider text-slate-500"><svg class="w-4 h-4 inline-block mr-1 -mt-0.5 text-indigo-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 15a4 4 0 004 4h9a5 5 0 10-.1-9.999 5.002 5.002 0 10-9.78 2.096A4.001 4.001 0 003 15z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 11l-3 4h4l-3 4"></path></svg> Atmospheric Radar</h4>
                    </div>
                    <div class="flex justify-between items-end pt-1">
                        <span id="weatherDesc" class="text-sm font-medium text-slate-700 capitalize">--</span>
                        <div class="text-right">
                            <span id="weatherTemp" class="block text-2xl font-bold font-mono text-slate-800">--°C</span>
                            <span id="weatherWind" class="block text-xs text-slate-500">-- km/h</span>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        let overlayExtensionMaps = {
            "<span style='color:#2563eb;font-weight:900;'>&#8212;</span> Evacuation Path": routeLayerGroup,
            "<span style='color:#ef4444;font-weight:900;'>- -</span> Submerged Zones": submergedLayerGroup,
            "<span style='color:#f59e0b;font-weight:900;'>&#8212;</span> Vulnerable Networks": warningLayerGroup
        };
